(function() {
  var addImagePost, addMediaPost, addPost, addTextPost, buildQuery, direction, getTemplate, loadPosts, loading, nextPage, page, posts, posts_per_page, updateFooter;
  ...
  buildQuery = function() {
    var url;
    return url = "http://api.are.na/v2/channels/random-access-memory/contents?page=" + page + "&per=" + posts_per_page + "&direction=" + direction;
  };
